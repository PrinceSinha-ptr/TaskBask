package `in`.porter.taskbask.servers.ktor.app
...
import `in`.porter.taskbask.servers.ktor.di.HttpComponentFactory
import com.fasterxml.jackson.core.JsonProcessingException
import com.fasterxml.jackson.databind.PropertyNamingStrategies
import com.fasterxml.jackson.databind.DeserializationFeature
import com.fasterxml.jackson.databind.MapperFeature
import com.fasterxml.jackson.module.kotlin.KotlinModule
import `in`.porter.taskbask.servers.ktor.task.taskRoute
import `in`.porter.taskbask.servers.ktor.user.userRoute
...
fun Application.main() {
  ...
  routing {
    ...
    route("user"){ userRoute(httpComponent) }
    route("task"){ taskRoute(httpComponent) }
  }
}
